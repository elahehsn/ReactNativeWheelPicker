...
public class WheelPickerManager extends SimpleViewManager<LoopView> implements LoopListener{
    ...
    @ReactProp(name = "selectedItemBgColor")
    public void setSelectedItemBgColor(LoopView wheelPicker, String selectedItemBgColor) {
        if (wheelPicker!=null){
            wheelPicker.setSelectedItemBgColor(convertColor(selectedItemBgColor));
        }
    }
